      ...
      <main className="pt-32 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-normal mb-8">
            About <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">SynapseAI</span>
          </h1>
          <p className="text-lg text-gray-400 mb-12 max-w-2xl mx-auto">
            Revolutionizing retail with AI-powered financial intelligence
          </p>
